...
const gStudyBlocklist = new Blocklist(readlinesFromFile('blocklists/study_blocklist.txt'))
const gFeatureBlocklist = new Blocklist(readlinesFromFile('blocklists/feature_blocklist.txt'))
